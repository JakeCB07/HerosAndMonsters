...
//calls base constructor and gets name of hero from user
    ...
    /*
     * public Hero createHero(Hero theHero, double chanceToHeal, AttackBehavior
     * attackBehavior, double chanceToBlock) {
     * 
    ...
    /*
     * public void readName() { Scanner kb = new Scanner(System.in);
     * 
     * System.out.print("Enter character name: "); String name = kb.nextLine();
     * 
     * }//end readName method
     */
    /*-------------------------------------------------------
    ...
    /*
     * public void gotHit(DungeonCharacter opponent) { if (defend()) {
     * System.out.println(getName() + " BLOCKED the attack!"); } else
     * 
     * opponent.getAttackBehavior().attack(opponent, this); }
     * 
     * /* public void subtractHitPoints(int hitPoints) { if (defend()) {
     * System.out.println(name + " BLOCKED the attack!"); } else {
    ...
    ---------------------------------------------------------*/
    /*
     * public void battleChoices(DungeonCharacter opponent) { int numTurns =
