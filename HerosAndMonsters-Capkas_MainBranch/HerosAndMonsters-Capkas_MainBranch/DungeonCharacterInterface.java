...
interface DungeonCharacterInterface
{
    ...
    abstract void subtactHitPoints(DungeonCharacterInterface opponent); // TODO these two may be the same

    interface Monster
    {
	abstract void attack(DungeonCharacterInterface opponent, DungeonCharacterInterface attacker);
    ...
    interface Hero
    {
	void attack(DungeonCharacterInterface opponent, DungeonCharacterInterface attacker);
