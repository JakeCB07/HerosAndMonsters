...
public class Dungeon {
	...
	public void makeMap() {
		...
		} while (loc1 == loc3 || loc3 == loc5 || loc5 == loc7 || loc7 == loc1 || loc5 == loc1 || loc7 == loc3
				|| loc10 == loc2 || loc10 == loc4 || loc10 == loc6 || loc10 == loc8);
		...
		System.out.println(loc1 + " " + loc2 + " " + loc3 + " " + loc4 + " " + loc5 + " " + loc6 + " " + loc7 + " "
				+ loc8 + " \n" + loc9 + loc10);
	...
	protected String printDungeon() {
		...
		for(int row = 1; row < retArray.length-1; row++) {
			for(int col = 1; col < retArray[row].length-1; col++) {
